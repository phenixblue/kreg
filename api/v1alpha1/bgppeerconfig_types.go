...
type BGPPeerConfigSpec struct {
	...
	// foo is an example field of BGPPeerConfig. Edit bgppeerconfig_types.go to remove/update
	// +optional
...
type BGPPeerConfigStatus struct {
	...
	// conditions represent the current state of the BGPPeerConfig resource.
